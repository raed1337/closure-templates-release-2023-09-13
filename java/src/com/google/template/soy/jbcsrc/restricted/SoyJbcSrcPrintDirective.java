...
public interface SoyJbcSrcPrintDirective extends SoyPrintDirective {
     ...
     */
    SoyExpression applyForJbcSrc(JbcSrcPluginContext context, SoyExpression value, List<SoyExpression> args);
    ...
    interface Streamable extends SoyJbcSrcPrintDirective {
        ...
        abstract class AppendableAndOptions {
             ...
             * to have its {@link java.io.Closeable#close()} method called to function correctly.
             */
         ...
         */
        AppendableAndOptions applyForJbcSrcStreaming(JbcSrcPluginContext context, Expression delegateAppendable, List<SoyExpression> args);
    }
}
